...
func showHelp() {
    print("".inBlack)
    print("usage: swiftformat [<file> <file> ...] [--output path] [--indent spaces] [...]")
    print("")
    print(" <file> ...        swift file or directory paths to be formatted")
    print("")
    ...
    print(" --rules           apply only the specified rules (pass no arguments to print rules")
    print("")
