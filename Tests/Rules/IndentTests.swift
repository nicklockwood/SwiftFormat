...
class IndentTests: XCTestCase {
    ...
    func testNoIndentIfConditionBodyAfterTrailingCommaInClosure() {
        let input = """
        withTrailingClosure {
            if
                foo.bar,
    ...
    func testNoIndentGuardConditionBodyAfterTrailingComma() {
        let input = """
        guard
            foo.bar,
            foo.baaz(
    ...
    func testNoIndentGuardConditionBodyAfterTrailingCommaInClosure() {
        let input = """
        withTrailingClosure {
            guard
                foo.bar,
