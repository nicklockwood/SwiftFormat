...
final class IndentTests: XCTestCase {
    ...
    func testIndentBlankLineBeforeSwitchCaseMatchesCaseIndent() {
        let input = """
        switch self {
        case .foo: "foo"
        case .bar: "bar"
        ...
        let options = FormatOptions(indentBlankLines: true)
        testFormatting(for: input, rule: .indent, options: options,
                       exclude: [.blankLineAfterSwitchCase, .consistentSwitchCaseSpacing])
    }

    func testIndentBlankLineBeforeSwitchCaseWithIndentCaseTrue() {
        let input = """
        switch self {
            case .foo: "foo"
            case .bar: "bar"
        ...
        """
        let options = FormatOptions(indentCase: true, indentBlankLines: true)
        testFormatting(for: input, rule: .indent, options: options,
                       exclude: [.blankLineAfterSwitchCase, .consistentSwitchCaseSpacing])
    }

    func testIndentBlankLineBeforeSwitchDefault() {
        let input = """
        switch foo {
        case .bar:
            bar()
    ...
    func testIndentBlankLineBeforeUnknownDefault() {
        let input = """
        switch foo {
        case .bar:
            bar()
    ...
    func testIndentBlankLineBeforeSwitchCaseInsideIfdef() {
        let input = """
        switch foo {
        #if DEBUG
            case .bar:
