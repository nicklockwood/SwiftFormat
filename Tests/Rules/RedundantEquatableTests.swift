...
final class RedundantEquatableTests: XCTestCase {
    ...
    func testInsertsImportBelowHeaderCommentWithNoOtherComments() {
        ...
        testFormatting(
            for: input, [output],
            rules: [.redundantEquatable, .blankLinesAtEndOfScope, .emptyExtension, .wrapAttributes, .consecutiveBlankLines],
            options: options
        )
    }
    ...
    func testInsertsImportBelowHeaderCommentWithOtherComments() {
        ...
        testFormatting(
            for: input, [output],
            rules: [.redundantEquatable, .blankLinesAtEndOfScope, .emptyExtension, .wrapAttributes, .consecutiveBlankLines, .sortImports],
            options: options
        )
    }
