...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testRemoveBlankLinesAtEndOfScope_Always", testRemoveBlankLinesAtEndOfScope_Always),
        ("testRemoveBlankLinesAtEndOfScope_Never", testRemoveBlankLinesAtEndOfScope_Never),
        ("testRemoveBlankLinesAtEndOfScope_Others", testRemoveBlankLinesAtEndOfScope_Others),
        ("testRemoveBlankLinesAtEndOfScope_Types", testRemoveBlankLinesAtEndOfScope_Types),
        ("testRemoveBlankLinesAtStartOfScope_Always", testRemoveBlankLinesAtStartOfScope_Always),
        ("testRemoveBlankLinesAtStartOfScope_Never", testRemoveBlankLinesAtStartOfScope_Never),
        ("testRemoveBlankLinesAtStartOfScope_Others", testRemoveBlankLinesAtStartOfScope_Others),
        ("testRemoveBlankLinesAtStartOfScope_Types", testRemoveBlankLinesAtStartOfScope_Types),
