...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testEmptyBracesNotRemovedInDoCatchWithSpacedConfiguration", testEmptyBracesNotRemovedInDoCatchWithSpacedConfiguration),
        ("testEmptyBracesNotRemovedInIfElse", testEmptyBracesNotRemovedInIfElse),
        ("testEmptyBracesNotRemovedInIfElseWithSpacedConfiguration", testEmptyBracesNotRemovedInIfElseWithSpacedConfiguration),
