...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testStrongSelfConvertedToSelfInOptions", testStrongSelfConvertedToSelfInOptions),
        ("testStrongSelfNotConvertedToSelfNotInOptions", testStrongSelfNotConvertedToSelfNotInOptions),
