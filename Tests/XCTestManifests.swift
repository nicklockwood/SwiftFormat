...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testBlankLinesBetweenImportsLong", testBlankLinesBetweenImportsLong),
        ("testBlankLinesBetweenImportsShort", testBlankLinesBetweenImportsShort),
        ("testBlankLinesBetweenImportsWithTestable", testBlankLinesBetweenImportsWithTestable),
